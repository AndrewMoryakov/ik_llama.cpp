...
struct gpt_params {
    ...
    bool repack_tensors_auto = false; // auto-disable repack for swap-bound MoE
    ...
    std::map<std::string, std::string> experimental_cli; // repeatable --experimental key=value runtime overrides
