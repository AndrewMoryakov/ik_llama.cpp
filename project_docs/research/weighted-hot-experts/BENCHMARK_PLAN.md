...
> **ИСТОРИЧЕСКИЙ ПЛАН. НЕ ЗАПУСКАТЬ ЭТУ МАТРИЦУ.** Указанного 151 GB артефакта
> по приведённому пути нет, а Step0 не обнаружил малого стабильного горячего
> множества. Текущий вывод и измерения: [`evidence-8`](../../../docs/sessions/2026-09-08-upstream-merge/evidence-8-step0-locality-2026-09-09.md)
> §4 и §6.
