(function (global) {
  ...
  function getConfidenceBadge(paramId, rawCtx, lang, helpers) {
    ...
    if (paramId === 'hot_expert_budget' || paramId === 'hot_expert_selection' || paramId === 'hot_expert_tail_window') {
      ...
      if (family === 'gpt-oss' && modelSizeTag === '120b') { level = 'medium'; titleRu = 'Tested on: gpt-oss-120b. Dedicated confirm kept this branch positive, but the effect is moderate rather than dominant.'; titleEn = 'Tested on: gpt-oss-120b. A dedicated confirm kept this branch positive, but the effect is moderate rather than dominant.'; }
